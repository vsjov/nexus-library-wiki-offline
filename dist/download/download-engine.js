 ...
 */
export const downloadFile = async (entry, outputDir) => {
    ...
    for (let attempt = 0; attempt < MAX_RETRIES; attempt++) {
        ...
        try {
            const bytesDownloaded = await downloadFileOnce(resolvedUrl, partPath, existingBytes, (downloaded, speed) => reporter.update(downloaded, speed));
            reporter.stop();
